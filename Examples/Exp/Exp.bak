...
!IF "$(CFG)" == ""
CFG=Exp - Win32 Debug
!MESSAGE No configuration specified.  Defaulting to Exp - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "Exp - Win32 Release" && "$(CFG)" != "Exp - Win32 Debug"
...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "Exp - Win32 Debug"
CPP=cl.exe
RSC=rc.exe
MTL=mktyplib.exe
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)/Exp.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=.\.
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/Exp.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /pdb:"$(OUTDIR)/Exp.pdb" /machine:I386 /out:"$(OUTDIR)/Exp.exe" 
LINK32_OBJS= \
	"$(INTDIR)\Exp.obj" \
	"$(INTDIR)\NSLApp.obj" \
	"..\..\include\nsllib.lib"

"$(OUTDIR)\Exp.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN : 
	...
	-@erase "$(OUTDIR)\Exp.exe"
	-@erase "$(OUTDIR)\Exp.ilk"
	-@erase "$(OUTDIR)\Exp.pdb"
	-@erase ".\exp.nsc"
...
CPP_PROJ=/nologo /MDd /W3 /Gm /GX /Zi /Od /I "..\..\include" /D "WIN32" /D\
 "_DEBUG" /D "_WINDOWS" /D "_AFXDLL" /D "_MBCS" /Fp"$(INTDIR)/Exp.pch" /YX\
...
LINK32_FLAGS=/nologo /subsystem:windows /incremental:yes\
 /pdb:"$(OUTDIR)/Exp.pdb" /debug /machine:I386 /out:"$(OUTDIR)/Exp.exe" 
LINK32_OBJS= \
	"$(INTDIR)\Exp.obj" \
	"$(INTDIR)\NSLApp.obj" \
	"..\..\include\nsllib.lib"
...
"$(INTDIR)\Exp.obj" : $(SOURCE) $(DEP_CPP_EXP_C) "$(INTDIR)"
...
"$(INTDIR)\Exp.obj" : $(SOURCE) $(DEP_CPP_EXP_C) "$(INTDIR)" ".\exp.nsc"
