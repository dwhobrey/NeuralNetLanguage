  ...
  for (;;) {
    ...
    */
	...
	continue;
      ...
      /*
         If we get here, we're dealing with a normal line.  We push back
         the token we just read, jump back to the top of the loop and
         re-read it with exp_token() to make sure it gets expanded.
      */
